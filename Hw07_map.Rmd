...
```{r}
corruption_year <- ggplot(africa_WB_clean, aes(map_id = country, frame = Year)) +
...
```{r}
gganimate_save(corr, "corruption.gif", ani.width = 400, ani.height = 400)

```

![Corruption](corruption.gif)
